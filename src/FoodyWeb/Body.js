...
function Body({ resName, cusine, cardRate, cardDetail, imgUrl,time,place ,near}) {
  return (
    <div className="card">
      ...
      <div className="Detail" >
        ...
        <p style={{ fontSize: "19px", marginTop: "11px" }}>{cardDetail}</p>
        <p style={{ fontSize: "19px", marginTop: "11px" }}>{time} min</p>
